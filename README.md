...
Kiến trúc tách frontend/backend (mục 2) cho phép deploy 2 nơi khác nhau mà không cần sửa code — chỉ cấu hình biến môi trường: **frontend trên Vercel**, **backend + PostgreSQL trên Render**.
